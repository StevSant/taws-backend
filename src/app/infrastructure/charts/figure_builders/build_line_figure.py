...
def build_line_figure(spec: ChartSpec, style: ChartImageStyle) -> Figure:
    """Render a single-series line chart (close prices, macro series) as a matplotlib Figure."""
    ...
    axes.plot(range(len(y_values)), y_values, color=style.accent_color, linewidth=1.8)
